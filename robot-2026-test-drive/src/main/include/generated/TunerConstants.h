...
private:
    ...
    static constexpr units::inch_t kWheelRadius = 1.9375_in;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.143310546875_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 12.1875_in;
    static constexpr units::inch_t kFrontLeftYPos = 12.1875_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.383056640625_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 12.1875_in;
    static constexpr units::inch_t kFrontRightYPos = -12.1875_in;

    // Back Left
    static constexpr int kBackLeftDriveMotorId = 19;
    static constexpr int kBackLeftSteerMotorId = 11;
    static constexpr int kBackLeftEncoderId = 22;
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.044189453125_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -12.1875_in;
    static constexpr units::inch_t kBackLeftYPos = 12.1875_in;

    // Back Right
    static constexpr int kBackRightDriveMotorId = 13;
    static constexpr int kBackRightSteerMotorId = 17;
    static constexpr int kBackRightEncoderId = 21;
    static constexpr units::turn_t kBackRightEncoderOffset = 0.41552734375_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -12.1875_in;
    static constexpr units::inch_t kBackRightYPos = -12.1875_in;
